        ...
        <footer className="bg-[#0a0a0a] text-white pt-16 pb-8 border-t border-[#D4AF37]/20 px-6 md:px-12 lg:px-20 mt-12">
            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
                ...
                <div className="space-y-4">
                    <h2 className="text-3xl font-playfair text-[#D4AF37]">Perfect Strands</h2>
                    <p className="text-sm text-gray-300 leading-relaxed">
                        Luxury human hair wigs crafted for queens who demand perfection.
                        Established 2023.
                    </p>
                    <div className="flex space-x-4 text-lg pt-2">
                        <a href="https://www.instagram.com/perfect_strands.ke/profilecard/?igsh=MW0ydjcxZDU5YjN4Mw==" target='_blank' className="hover:text-[#D4AF37] transition-colors duration-300">
                            <FaInstagram />
                        </a>
                        <a href="https://www.tiktok.com/@perfect_strands.ke?_t=ZM-8vvODE3yeZR&_r=1" target='_blank' className="hover:text-[#D4AF37] transition-colors duration-300">
                            <FaTiktok />
                        </a>
                        <a href="#" className="hover:text-[#D4AF37] transition-colors duration-300" target='_blank'>
                            <FaPinterest />
                        </a>
                    </div>
                </div>
                ...
                {/* Quick Links */}
                <div>
                    <h3 className="text-lg font-semibold mb-5 pb-2 border-b border-[#D4AF37]/30 text-[#D4AF37]">Explore</h3>
                    <ul className="space-y-3">
                        {[
                            ...
                            <li key={item.name}>
                                <Link href={item.href} className="text-gray-300 hover:text-[#D4AF37] transition-colors text-sm">
                                    {item.name}
                                </Link>
                            </li>
                        ))}
                ...
                {/* Customer Care */}
                <div>
                    <h3 className="text-lg font-semibold mb-5 pb-2 border-b border-[#D4AF37]/30 text-[#D4AF37]">Customer Care</h3>
                    <ul className="space-y-3">
                        {[
                ...
                <div className="flex flex-col gap-3">
                    {/* Newsletter */}
                    <div>
                        <h3 className="text-lg font-semibold mb-5 pb-2 border-b border-[#D4AF37]/30 text-[#D4AF37]">Get Updates</h3>
            ...
            <div className="max-w-7xl mx-auto px-6 mt-8 pt-6 border-t border-[#333] text-center">
                <div className="flex flex-col md:flex-row justify-between items-center text-xs text-gray-500 space-y-2 md:space-y-0">
                    <div>
                        © {new Date().getFullYear()} Perfect Strands, by <span className='underline hover:text-[#D4AF37]'><a href="https://instagram.com/404elvisnotfound" target='_blank'>lvs.gk</a></span> All rights reserved.
                    </div>
